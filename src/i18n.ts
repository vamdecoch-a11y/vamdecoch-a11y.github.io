...
const it: Dict = {
  ...
  pd_prima: 'Prima', pd_dopo: 'Dopo', pd_alt_prima: 'Prima del lavoro', pd_alt_dopo: 'Dopo il lavoro VAM Deco',
  pd_titolo_label: 'Prima e dopo', pd_titolo_h: 'Guarda la differenza',
...
const en: Dict = {
  ...
  pd_prima: 'Before', pd_dopo: 'After', pd_alt_prima: 'Before the work', pd_alt_dopo: 'After the VAM Deco work',
  pd_titolo_label: 'Before and after', pd_titolo_h: 'See the difference',
...
const de: Dict = {
  ...
  pd_prima: 'Vorher', pd_dopo: 'Nachher', pd_alt_prima: 'Vor der Arbeit', pd_alt_dopo: 'Nach der Arbeit von VAM Deco',
  pd_titolo_label: 'Vorher und nachher', pd_titolo_h: 'Sehen Sie den Unterschied',
